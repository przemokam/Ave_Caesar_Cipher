...
def cipher_decode(message, offset):
  decoded_message = ""
...
def cipher_encode(message, offset):
  encoded_message = ""
  for character in message:
    if character in alphabet:
      character_value = alphabet.find(character)
...
print("\033[91m1.\033[0m Decode message (I know offset)")  
print("\033[91m2.\033[0m Decode message (I don't know the offset and I need to brute force it!)")
...
if choice == '1':
    ...
    offset = int(input("\033[1mPlease enter the offset of cipher:\033[0m "))
    print("\033[1mYour decoded message is:\033[0m", cipher_decode(message_to_decode, offset))
    ...
    offset = int(input("\033[1mPlease enter the offset of cipher:\033[0m "))
    print("\033[1mYour encoded message is:\033[0m", cipher_encode(message_to_encode, offset))
